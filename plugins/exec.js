...
let peli = await (await fetch('https://telegra.ph/file/b65957f39a82395bb09d0.jpg')).buffer()
let ye = await (await fetch('https://telegra.ph/file/b65957f39a82395bb09d0.jpg')).buffer()
  let _return
  let _syntax = ''
