...
let name = m.fromMe ? conn.user : conn.contacts[m.sender]
    ...
    let buttons = [
{buttonId: '.kerja', buttonText: {displayText: 'Kerja'}, type: 1}, 
]
const buttonMessage = {
    contentText: `\n*😴Sepertinya Anda Sudah Kecapekan Silahkan Istirahat Dulu sekitar* _${timers}_ *Untuk bisa melanjutkan Ojek*\n`,
    footerText: wm, 
    buttons: buttons,
    headerType: 1
}
    if (new Date - global.db.data.users[m.sender].as > 300000) {
